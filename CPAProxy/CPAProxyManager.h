...
typedef void (^CPAProxyManagerHiddenServiceConnectedToIntroBlock)();
typedef void (^CPAProxyManagerHiddenServiceConnectedToRendezvousBlock)();
...
@property (nonatomic, copy, readwrite) CPAProxyManagerHiddenServiceConnectedToIntroBlock didConnectedToIntroBlock;
@property (nonatomic, copy, readwrite) CPAProxyManagerHiddenServiceConnectedToRendezvousBlock didConnectedToRendezvousBlock;
